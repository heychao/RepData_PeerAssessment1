...
The output above shows that there is only one interval (`r sorted_int_step_avg[1,1]`) that features a maximum daily step average, which is **`r sorted_int_step_avg[1,2]`**.
